...
[Skip to Planned Features](#planned-features)

Demo: 

http://sandbox.hudsondemo.com/hmodal
...
* Refactoring to make code more readable/performative
* Chris testing this out!! feafeafeafeafeafeaefea   